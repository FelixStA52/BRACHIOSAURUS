...
#define EPOCH_TIME 1742167556 //Unix time corresponding to when the BRACHIOSAURUS is turned on

#define LOOPS_PER_WAKE_UP 10 //how many data points are taken in a wake up loop

#define SEC_TO_SLEEP 14400 //time (seconds) the microcontroller goes to sleep between taking data
