...
#define BOX_NUMBER "5" //number of the box

#define SAMPLES 2048 //number of samples taken, needs to be a power of 2 i.e. 2^n

#define EPOCH_TIME 0//1742167556 //Unix time corresponding to when the BRACHIOSAURUS is turned on

#define LOOPS_PER_WAKE_UP 2//10 //how many data points are taken in a wake up loop

#define SEC_TO_SLEEP 20//14400 //time (seconds) the microcontroller goes to sleep between taking data
